...
export default function Home() {
  ...
  return (
    <div className="h-screen flex flex-col gap-20 w-full">
      <main className="h-4/5 w-full relative  z-0 ">
        <div className="bg-gradient-to-br from-slate-50 via-slate-50 to-emerald-400 w-full">
          <div className="w-full max-w-screen-xl mx-auto ">
            <section className="max-h-full grid grid-cols-1 md:grid-cols-2  items-start max-w-7xl ">
                ...
                <div className="flex flex-col gap-10">
                  ...
                  <div className="flex flex-col gap-4 items-start">
                    ...
                    <p className="text-xl md:text-2xl tracking-wider text-slate-400">
                      Connect with top organizations and clients on our
                      platform! Find your perfect match to your expertise.
                    </p>
                    <div>users image</div>
      ...
      <div className=" h-[350px] flex justify-center items-center w-full ">
        <section className="flex flex-col justify-center items-center gap-12 w-full max-w-screen-xl mx-auto">
          <h1 className="text-2xl font-bold tracking-wide">
            Trusted by 2000+ Organization
          </h1>
          <div className="flex justify-center items-center space-x-24 px-2">
            {image.map((item) => (
              <Image
                key={item.id}
                src={item.image}
      ...
      <main className="h-[580px] flex items-center py-16 ">
        <section className=" px- flex flex-col w-full max-w-screen-xl mx-auto ">
      ...
      <main className="h-full w-full bg-slate-100">
        <section className="w-full max-w-screen-xl mx-auto flex flex-col gap-10 p-">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
            {Skills.map((item) => (
              <div
                key={item.id}
                className="bg-white p-6 rounded-lg shadow-md flex flex-col gap-5"
              >
                <div>
      ...
      <main className="h-fit w-full mt-20">
        <section className="w-full max-w-screen-xl mx-auto pt-20 pb-14 flex flex-col gap-5 h-full justify-center items-center ">
          <div className="grid grid-cols-2 w-full gap-24 h-full">
            ...
            <div className="col-span-1 relative flex justify-center items-center">
              <div className="bg-sky-100/50 w-full h-[450px] flex items-end justify-center rounded-lg overflow-hidden"></div>

              <div className="absolute inset-0 w-full h-full flex justify-center items-center">
                <div className="relative">
                  <Image src={man} alt="man" className="relative z-0 -top-6" />
                  <Image
                    src={star}
                    alt="star"
      ...
      <div className="h-[750px] flex items-center justify-center mt-20 ">
        <section className="w-full max-w-screen-xl flex flex-col gap-16 ">
      ...
      <div className="h-[850px] flex items-center justify-center mt-20">
        <div className="bg-emerald-500/80 w-full max-w-screen-xl h-[90%] py-14 rounded-3xl grid grid-cols-1 md:grid-cols-2 gap-6 relative">
          {/* Left Section */}
